...
class _SidebarState extends ConsumerState<Sidebar> {
  ...
  Widget _buildSidebarLogo() => Row(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(top: 9.0) * AnalyticsApp.size,
  ...
  SidebarXTheme _theme() => SidebarXTheme(
        ...
        itemTextPadding: const EdgeInsets.only(left: 7.0) * AnalyticsApp.size,
        selectedItemTextPadding:
            const EdgeInsets.only(left: 7.0) * AnalyticsApp.size,
